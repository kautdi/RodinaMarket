...
const CompanyZakazs: FC = () => {
    ...
    async function changeStatus(id: number){
        const changeStatus = await ZakazService.changeStatus(id , "Complete");
